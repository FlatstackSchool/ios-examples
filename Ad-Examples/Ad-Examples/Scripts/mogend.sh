...
mogenerator --swift --model "${INPUT_FILE_PATH}/" --machine-dir "${PROJECT_DIR}/Ad-Examples/CoreData/Private/" --human-dir "${PROJECT_DIR}/Ad-Examples/CoreData/" --template-var arc=true
