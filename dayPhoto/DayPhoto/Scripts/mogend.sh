...
mogenerator --swift --model "${INPUT_FILE_PATH}/" --machine-dir "${PROJECT_DIR}/DayPhoto/CoreData/Private/" --human-dir "${PROJECT_DIR}/DayPhoto/CoreData/" --template-var arc=true
