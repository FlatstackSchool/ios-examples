...
mogenerator --swift --model "${INPUT_FILE_PATH}/" --machine-dir "${PROJECT_DIR}/Json-Api-Example/CoreData/Private/" --human-dir "${PROJECT_DIR}/Json-Api-Example/CoreData/" --template-var arc=true
