...
mogenerator --swift --model "${INPUT_FILE_PATH}/" --machine-dir "${PROJECT_DIR}/Authorization-module/CoreData/Private/" --human-dir "${PROJECT_DIR}/Authorization-module/CoreData/" --template-var arc=true
